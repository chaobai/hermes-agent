...
(function () {
  ...
  const FALLBACK_COLUMN_HELP = {
    ...
    review: "Waiting for a worker to review",
    done: "Completed",
    archived: "Archived",
  };
  ...
  function OrchestrationPanel() {
    ...
    const visibleProfiles = profiles.filter(function (p) {
      return !p.is_default;
    });
    const profileOptions = visibleProfiles.map(function (p) {
    ...
    return h(Card, { className: "p-3" },
      h(CardContent, { className: "p-2 flex flex-col gap-3" },
        ...
        settings ? h("div", { className: "grid gap-3 sm:grid-cols-3" },
          h("div", { className: "flex flex-col gap-1" },
            ...
            h(Select, Object.assign({
              value: settings.orchestrator_profile || settings.resolved_orchestrator_profile || "",
              className: "h-8",
            ...
            h("div", { className: "text-[10px] text-muted-foreground" },
              "Fallback: " + (settings.resolved_orchestrator_profile || "default")),
            h("div", { className: "text-[10px] text-muted-foreground" },
          ...
          h("div", { className: "flex flex-col gap-1" },
            h(Label, { className: "text-xs text-muted-foreground" },
              "Fallback assignee"),
            h(Select, Object.assign({
              value: settings.default_assignee || settings.resolved_default_assignee || "",
              className: "h-8",
            }, selectChangeHandler(function (v) {
            ...
            h("div", { className: "text-[10px] text-muted-foreground" },
              "Fallback: " + (settings.resolved_default_assignee || "default")),
          ),
          h("div", { className: "flex flex-col gap-1" },
            h(Label, { className: "text-xs text-muted-foreground" },
              "Orchestration mode"),
        ...
        visibleProfiles.length === 0
          ? h("div", { className: "text-xs text-muted-foreground" }, "No non-default profiles installed.")
